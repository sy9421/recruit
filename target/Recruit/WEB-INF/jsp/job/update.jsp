	...
	<div class="row">
		<div class="col-md-10">
			<form class="form-horizontal" method="post"
				action="${base_url }/recruit/updateRecruit">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="position" name="position"
							placeholder="职位" value="${recruit.position }">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea rows="5" class="form-control" style="resize: none;"
								  name="introduce" id="introduce" placeholder="介绍"
								  value="${recruit.introduce }">${recruit.introduce }</textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="location" class="col-sm-3 control-label">工作地点</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="location"
							name="location" placeholder="工作地点" value="${recruit.location}">
					</div>
				</div>
